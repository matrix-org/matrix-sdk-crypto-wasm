...
`;
    ...
    test("can be instantiated with a pure-Rust X.509 verifier", async () => {
        expect(
            await OlmMachine.initialize(
                new UserId("@foo:bar.org"),
                new DeviceId("baz"),
    ...
    test("can be instantiated with a store and a pure-Rust X.509 verifier", async () => {
